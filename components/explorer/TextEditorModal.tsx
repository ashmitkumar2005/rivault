...
export function TextEditorModal({ isOpen, onClose, onSave, fileName, initialContent }: TextEditorModalProps) {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm animate-fade-in">
            <div className="w-full h-full md:w-[90vw] md:h-[90vh] bg-[#1e1e1e] md:rounded-xl shadow-2xl flex flex-col border border-white/10 overflow-hidden">
                {/* Header */}
                <div className="h-12 bg-[#2d2d2d] flex items-center justify-between px-4 border-b border-black/50 select-none">
